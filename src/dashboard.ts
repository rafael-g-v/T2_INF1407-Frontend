...
import {
  ...
  setLoading, formatDate, iniciais,
} from "./auth.js";
...
(async () => {
  ...
  if (window.location.hash === "#convites") switchTab("convites");
...
async function loadProjetos(): Promise<void> {
...
function switchTab(tab: "projetos" | "convites"): void {
